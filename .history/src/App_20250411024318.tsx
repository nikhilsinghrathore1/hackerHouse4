...
export function App() {
   ...
   async function messageResult(gameProcess: string, tags: { name: string; value: string }[], data?: any) {  
          ...
          <div className="md:w-1/2 h-full flex flex-col">
            ...
            <div className="border-t">
              <TestRunner 
                ...
                onTestSuccess={() => markProblemAsSolved(selectedProblem.id)  messageResult("rK6rVBjETGNZOLQ6SaM0XOLrfBq6OnM5En6KlXWiuUg" ,  [
                  {
                    name: "Action",
